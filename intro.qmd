...
Here's a video that I worked on with one of my [colleagues](https://dribbble.com/bashwax) from the creative industry to describe the Inclusionary Housing Policy Framework:

{{< video https://youtu.be/_KF0V7J7zFY >}}

I've always enjoyed data and working with numbers, which is what drew me to my current pursuit: an MSc Urban Spatial Science at University College London's [Centre for Advanced Spatial Analysis](https://www.ucl.ac.uk/bartlett/casa/bartlett-centre-advanced-spatial-analysis). This site is a learning diary for one of my modules, Remotely Sensing cities and Environments. I hope that you enjoy it!
